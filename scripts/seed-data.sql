...
('Pulpen Biru', 'PEN-BLUE', 'pcs', 'Alat Tulis'),
...
-- Insert sample warehouse products (stock)
...
(1, 7, 500, 5000, 7500),        -- Pulpen Biru
(1, 8, 300, 15000, 20000),      -- Buku Tulis
...
(2, 7, 400, 5000, 7500),        -- Pulpen Biru
(2, 9, 25, 1500000, 1800000),   -- Meja Kantor
(2, 10, 40, 800000, 1000000),   -- Kursi Kantor

-- Gudang Bandung (id: 3)
(3, 2, 60, 150000, 200000),     -- Mouse Wireless
(3, 4, 20, 2000000, 2500000),   -- Monitor 24 inch
(3, 5, 15, 3000000, 3500000),   -- Printer Canon
(3, 6, 100, 50000, 65000),      -- Kertas A4
(3, 8, 200, 15000, 20000),      -- Buku Tulis
(3, 9, 30, 1500000, 1800000),   -- Meja Kantor
(3, 10, 50, 800000, 1000000),   -- Kursi Kantor

-- Gudang Medan (id: 4)
(4, 1, 20, 8000000, 10000000),  -- Laptop Dell
(4, 3, 40, 500000, 650000),     -- Keyboard Mechanical
(4, 4, 25, 2000000, 2500000),   -- Monitor 24 inch
(4, 6, 80, 50000, 65000),       -- Kertas A4
(4, 7, 300, 5000, 7500),        -- Pulpen Biru
(4, 8, 150, 15000, 20000)       -- Buku Tulis
...
(6, 2, 'IN', 100, 'Pembelian kertas A4', NULL, NULL),

-- Stock OUT transactions
(1, 1, 'OUT', 5, 'Penjualan ke customer', NULL, NULL),
(2, 1, 'OUT', 10, 'Penjualan retail', NULL, NULL),

-- Transfer transactions
(2, 1, 'TRANSFER', 20, 'Transfer mouse ke Surabaya', 1, 2),
(6, 2, 'TRANSFER', 50, 'Transfer kertas ke Bandung', 2, 3);
